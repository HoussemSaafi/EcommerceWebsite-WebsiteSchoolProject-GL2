...
class crudChat
{
	...
	public function __construct()
	{
     ...
     public function savechat($upseudo,$umessage)
     {
    		try
		{
			...
			$stmt = $this->conn->prepare('INSERT INTO chat (Pseudo, message) VALUES(:upseudo, :umessage)');
    ...
    public function loadchat()
    {
		...
		{ 
			...
			$reponse = $this->conn->query('SELECT Pseudo, message ,datechat FROM chat ORDER BY  Idchat DESC LIMIT 0, 30');
    	 	return $reponse;
