...
include'class.user.php';
	...
	$_SESSION['thispage']="preview.php?IDProduit=".$_GET["IDProduit"];
						   ...
						   <div id="products_example">
							   <div id="products">
								<div class="slides_container" style="width=250 px">
									...
									$result=$conn->query("SELECT * FROM produit WHERE IDProduit=".$_GET['IDProduit']);
							        $res=$result->fetchAll();
					...
					foreach($res as $r)
							    {
									...
									{
										echo '<input type="submit" class="btn btn-primary" value="Add to Cart" ></span></div>';
									}
								}
				 ...
				 <div class="product-tags">
					...
					<div class="input-box">
						<p>
						 ...
						 <?php 	
						 		$result_Cat=$conn->query("SELECT DesignationCat,Description FROM Categorie WHERE IDCategorie=".$res[0]['ID_Categorie']);
   ...
   <div class="section group">
	      <?php
		          ...
		          foreach($res as $r)
		          {
		            ...
		            echo '<a href="preview.php?IDProduit='.$r['IDProduit'].'"><div style="width: 250px; height: 250px;;overflow:hidden"><img  src="data:image/jpeg;base64,'.base64_encode($r['ImgProduit']).'" /></div></a>';
		            echo ' <h2>'.$r['Designation'].' </h2>';
